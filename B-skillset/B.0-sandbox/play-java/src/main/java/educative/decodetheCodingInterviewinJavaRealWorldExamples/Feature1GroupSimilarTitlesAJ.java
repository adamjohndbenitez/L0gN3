 ...
 */
public class Feature1GroupSimilarTitlesAJ {
    ...
    public static List<List<String>> groupTitles(String[] strs) {
        ...
        // result will be a hash map of List of strings
        Map<String, List<String>> res = new HashMap<String, List<String>>();

        // count is the index per letter in the alphabet
        int[] count = new int[26];
        for (String s : strs) {

            Arrays.fill(count, 0); // resets all elements of count array to 0
